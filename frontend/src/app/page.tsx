        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            featureList: [
              ...
              "Voice-Led Company Concierge",
              "Voice-First Lead Capture",
              "Autonomous Business Provisioning",
              "19-Agent Workforce",
              "Autonomous Lead Discovery",
              "Nurture Engine",
              "Outreach Maximization",
              "Deliverability & DNS Suite",
              "Monetization Engine",
              "Launch Studio + Traffic Engine",
              "Programmatic SEO",
              "Autonomous Workflow Engine",
              "Sales Pipeline & Forecasting",
              "CRM + Interaction Timeline",
              "Revenue Map & Win-Back",
  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-transparent via-indigo-950/30 to-transparent">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-8 mb-10 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 rounded-2xl border border-emerald-500/25 bg-emerald-500/[0.06] px-6 py-4 text-sm text-white/70">
          <span className="flex items-center gap-2">
            ...
            <span className="font-semibold text-white">14-day money-back guarantee</span>
          </span>
          <span className="flex items-center gap-2">
            <svg className="w-4 h-4 text-emerald-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
            </svg>
            Every outreach & follow-up drafted, then human-approved
          </span>
          <span className="flex items-center gap-2">
            <svg className="w-4 h-4 text-emerald-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
            Voice-driven company launch included on every plan
          </span>
        </div>
