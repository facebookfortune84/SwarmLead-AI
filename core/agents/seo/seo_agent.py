...
class SEOAgent:
    ...
    def _setup_default_configs(self):
        ...
        self.programmatic_configs = [
            ProgrammaticSEOConfig(
                ...
                keywords_template=["{industry} lead generation", "{industry} automation", "AI {industry}"]
            ),
            ProgrammaticSEOConfig(
                ...
                keywords_template=["how to {use_case}", "{use_case} tutorial", "{use_case} automation"]
            ),
            ProgrammaticSEOConfig(
                ...
                keywords_template=["{template_name} template", "free {template_name}", "{category} template"]
            ),
            ProgrammaticSEOConfig(
                ...
                keywords_template=["{competitor} alternative", "Genesis vs {competitor}", "{competitor} vs Genesis"]
            ),
            ProgrammaticSEOConfig(
    ...
    def _generate_meta_tags(self, page_type: str, context: Dict) -> Dict:
        ...
        return {
            ...
            "description": context.get("description", "Launch your business with AI agents. Voice-first, autonomous, compliant."),
            ...
            "twitter:description": context.get("description", "Launch your business with AI agents.")
        }
    ...
    async def optimize_core_web_vitals(self, page_url: str) -> Dict:
        ...
        return {
            "lcp": {"target": "< 2.5s", "actions": ["Optimize images", "Preload critical resources", "Reduce server response time"]},
            "fid": {"target": "< 100ms", "actions": ["Minimize main thread work", "Use web workers", "Code splitting"]},
            "cls": {"target": "< 0.1", "actions": ["Set image dimensions", "Reserve space for ads", "Font display swap"]},
            "inp": {"target": "< 200ms", "actions": ["Optimize event handlers", "Debounce inputs", "Use useTransition"]}
        }
