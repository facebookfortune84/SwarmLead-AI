...
class LandingAgent(StrategyAgent):
    ...
    FLOWS = {
        ...
        "product_recommendation": {
            ...
            "qualification_criteria": {"has_team_size": True, "has_budget": True},
    ...
    async def greet_visitor(self, session_id: str, visitor_context: Dict) -> Dict:
        """
    ...
    def _get_flow_options(self, flow: str) -> List[str]:
        ...
        return self.flows.get(flow, {}).get(
            "options", ["Explore features", "Talk to human", "Schedule demo"]
        )
    ...
    async def _flow_lead_qualification(self, session_id: str, context: Dict) -> Dict:
        ...
        return await self._execute_conversation_flow(
            session_id,
            "lead_qualification",
            [
                (
                ...
                (
                    ...
                    ["Lead gen", "Conversion", "Retention", "Scaling"],
                ),
            ],
        )
        ...
        return await self._execute_conversation_flow(
            ...
            [
                ...
                (
                    "team",
                    "Do you have a team?",
                    ["Solo", "Co-founder", "Small team", "Building team"],
                ),
            ],
        )
        ...
        return await self._execute_conversation_flow(
            ...
            [
                ...
                (
                    ...
                    ["ASAP", "This month", "This quarter", "Planning"],
                ),
            ],
        )
        ...
        return await self._execute_conversation_flow(
            ...
            [
                (
                    "category",
                    "What type of tool?",
                    ["CRM", "Email", "Analytics", "Project mgmt", "All"],
                ),
    ...
    async def _execute_conversation_flow(
        self, session_id: str, flow_name: str, questions: List[tuple]
    ) -> Dict:
