...
class ContentAgent(BaseAgent):
    ...
    def _setup_default_templates(self):
        ...
        self.templates = {
            ...
            "landing": ContentTemplate(
                ...
                structure=["hero", "problem", "solution", "benefits", "social_proof", "pricing", "faq", "cta"],
            ...
            "case_study": ContentTemplate(
                ...
                structure=["challenge", "solution", "implementation", "results", "testimonial", "cta"],
            ...
            "whitepaper": ContentTemplate(
                ...
                structure=["executive_summary", "problem", "solution", "methodology", "results", "conclusion", "appendix"],
    ...
    def _build_prompt(self, template: ContentTemplate, context: Dict, seo_keywords: List[str]) -> str:
    ...
    async def generate_blog_post(self, topic: str, keywords: List[str], context: Dict) -> Dict:
        """Generate blog post."""
        return await self.generate_content("blog", {
            "topic": topic,
            "keywords": keywords,
            **context
        }, seo_keywords=keywords)
    
    async def generate_landing_page(self, product: str, features: List[str], benefits: List[str]) -> Dict:
        """Generate landing page copy."""
        return await self.generate_content("landing", {
            "product": product,
            "features": features,
            "benefits": benefits
        })
    ...
    async def generate_email_sequence(
        ...
        for i in range(steps):
            email = await self.generate_content("email", {
                "step": i + 1,
                "total_steps": steps,
    ...
    async def generate_social_posts(self, topic: str, count: int, platform: str) -> List[Dict]:
        ...
        for i in range(count):
            post = await self.generate_content("social", {
                "topic": topic,
                "platform": platform,
                "post_number": i + 1
            })
    ...
    async def generate_case_study(
        ...
        """Generate case study."""
        return await self.generate_content("case_study", {
            "company": company,
            "challenge": challenge,
            "solution": solution,
            "results": results
