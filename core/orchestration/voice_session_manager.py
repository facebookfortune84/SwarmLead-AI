...
from core.orchestration.scheduler import Scheduler, ScheduledTask, TaskStatus
...
class VoiceSessionManager(Scheduler):
    ...
    async def create_session(
        ...
        session = VoiceSession(
            ...
            tenant_id=tenant_id,
            expires_at=datetime.utcnow() + timedelta(minutes=timeout or self.default_timeout_minutes),
    ...
    async def add_turn(self, session_id: str, role: str, text: str, audio_meta: Dict = None) -> bool:
